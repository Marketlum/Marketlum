...
const ARCHETYPES = [
  ...
  { code: 'market_maker', name: 'Market Maker', purpose: 'Facilitates transactions between parties', description: 'Actors who connect supply and demand, enabling exchanges between producers and consumers.' },
