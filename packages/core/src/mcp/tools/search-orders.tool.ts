...
export class SearchOrdersTool implements McpTool<McpSearchOrdersInput> {
  ...
  readonly description =
    'Search orders with pagination and optional filters: lifecycle state, counterparty actors ' +
    '(fromActorId / toActorId or actorId for either side), channel, pipeline and currency. ' +
