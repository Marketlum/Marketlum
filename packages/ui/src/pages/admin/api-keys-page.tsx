...
export async function ApiKeysPage() {
  ...
  return (
    <div>
      ...
      <h1 className="mb-1 flex items-center gap-2 md:gap-3 text-2xl md:text-3xl font-bold">
        <KeyRound className="h-6 w-6 md:h-8 md:w-8" />
        {t('apiKeys.title')}
      </h1>
      <p className="mb-4 md:mb-6 text-sm text-muted-foreground">{t('apiKeys.description')}</p>
      <ApiKeysDataTable />
    </div>
  );
}
