...
import { ExchangeRatesDataTable } from '../../components/exchange-rates/exchange-rates-data-table';
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export async function ExchangeRatesPage() {
    ...
    <div>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>{t('exchangeRates.title')}</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
