Feature: RDHY VAM agreements
  ...
  co-creation plan for an actor over a time horizon, sponsored by an
  ...
  Background:
    ...
    And an actor exists with name "Web3 ME"

  Scenario: Creating a draft VAM agreement
    When I create a VAM agreement titled "Web 3 Consulting HUB" for the actor "Web3 ME" sponsored by "industrial_platform" over 12 months
  ...
  Scenario: Creating a VAM agreement for an unknown actor fails
    When I create a VAM agreement titled "Orphan" for an unknown actor sponsored by "industrial_platform" over 12 months
    Then the response status should be 404

  Scenario: Creating a VAM agreement with an unknown sponsor platform fails
    When I create a VAM agreement titled "Unsponsored" for the actor "Web3 ME" sponsored by an unknown platform over 12 months
    Then the response status should be 404

  Scenario: Rejecting an invalid horizon
    When I create a VAM agreement titled "Instant" for the actor "Web3 ME" sponsored by "industrial_platform" over 0 months
    Then the response status should be 400

  Scenario: Listing VAM agreements with summaries
    Given a VAM agreement titled "First Cycle" exists for the actor "Web3 ME" sponsored by "industrial_platform"
    And a VAM agreement titled "Second Cycle" exists for the actor "Web3 ME" sponsored by "industrial_platform"
    When I list VAM agreements
    Then the response status should be 200
    And the VAM agreement list contains "First Cycle" with actor "Web3 ME" and platform "industrial_platform"
    And the VAM agreement list contains "Second Cycle" with actor "Web3 ME" and platform "industrial_platform"
