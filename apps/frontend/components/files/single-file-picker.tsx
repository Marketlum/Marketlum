...
export function SingleFilePicker({ value, onChange, accept }: SingleFilePickerProps) {
  ...
  const mimeGroup = accept === "image/*" ? "image" : undefined;
  ...
  const IconComponent = value ? getFileIcon(value) : null;
